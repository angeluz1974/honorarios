...
#Define NULA									chr(0x00)
#Define NULW									chr(0x00)+chr(0x00)
#Define NULCHAR									chr(0x00)
#Define TABCHAR									chr(0x09)
...
*!* VISTA Imagelist should enable use of the high quality scaler.
...
*!* VISTA Imagelist should accept smaller than set images and apply OriginalSize based on image added
